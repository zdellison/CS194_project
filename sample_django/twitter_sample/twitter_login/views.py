...
# Project
from twitter_login.models import Profile
...
def t_login(request):
    ...
    #NOTE: I changed this to a post based on the Twitter Oauth page, but
    # it's different than what the original code had.
...
def twitter_authenticated(request):
    print request.session
    print "Check if session is the same."
    if (request.session['test']):
        print "Session test is true."
