...
//sets how many color shades will be produced (with 50, each state has unique color)
var COLOR_COUNTS = 50;
...
//sets color for greatest (color last) and for least (color first) Hexadecimal values
var COLOR_LAST = "#FF0000", COLOR_FIRST = "#6495ED";
...
//these variables should match the CSVs on the first line of data
var MAP_STATE = "state_name";
var MAP_VALUE = "Amateur_hockey_players_per_OHT";
var STATE_RANK = "rank";
var width = WIDTH,
    height = HEIGHT;
...
function makeBars() {
  ...
  Object.keys(name_id_map).forEach(function(n) {
    if (valueById.get(+name_id_map[n])) {
      ...
      total_states += valueById.get(+name_id_map[n]);
      states_count++;
    }
  });
...
/*
sorting function to sort greatest to least line
151 should read return -(b.value -a.value); 
to sort least to greatest line 151 should read return -(a.value - b.value);
To sort alphabetically void out lines 146-152 
 */ 
  ...
  svg.append("g")
    ...
    .enter().append("path")
      ...
      .on("mousemove", function(d) {
          ...
          html += " = hockey players per 100,000 residents";
          html += "</span>";
          html += "<span class=\"tooltip_key_rank\">";
          html += "<br>Rank";
          html += "</span>";
          html += "<span class=\"tooltip_value_rank\">";
          html += rank[d.id];
          html += "</span>";
          html += "</div>";
